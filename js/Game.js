        ...
        displayRanks(){
          ...
          for(var plr in allPlayers){
            if(allPlayers[plr].place === 1){
              text('First!:)' + allPlayers[plr].name + ' well done', 0, 85)

            }
            else if(allPlayers[plr].place === 2){
              text('Second!:)' + allPlayers[plr].name + ' well done', displayWidth/4, displayHeight / 9+73)
            }
            else if(allPlayers[plr].place === 3){
              text('Third!:)' + allPlayers[plr].name + ' well done', displayWidth / -4, displayHeight/10 + 76)
            }
            else{
              text('haha you lost :(', 0, 225)
            }
          }
        }
